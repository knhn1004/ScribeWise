...
if __name__ == "__main__":
    if len(sys.argv) < 2:
        print(
            "Usage: python anki_converter.py <flashcards_json_file> [output_format] [deck_name]"
        )
        print("Output formats: txt (default), csv, apkg")
        print(
            "Example: python anki_converter.py outputs/video_flashcards.json apkg 'My Deck Name'"
        )
        sys.exit(1)
